...
1. Open Maticon Office editors and create a new spreadsheet.
...
If you want to speed up the process, starting from version 9.0, you can use the AI plugin built into Maticon Office to automatically generate Maticon Office macros from their descriptions:
