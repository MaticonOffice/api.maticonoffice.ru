...
To debug Maticon Office macros, follow the instructions below.
...
3. To run your script in debug mode:
   ...
   - **For Maticon Office Docs**: open the developer console by pressing the **F12** button.
   - **For Desktop Editors**: use the [instruction](../../desktop-editors/usage-api/debugging.md) for debugging in Maticon Office Desktop Editors.
