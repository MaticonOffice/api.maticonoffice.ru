...
Macros are small scripts used to facilitate your day-to-day routine work with different types of documents. Maticon Office macros use the JavaScript syntax and [Office JavaScript API](../../office-api/get-started/overview.md) scripting notation.

There are several reasons why Maticon Office uses JavaScript for macros:
