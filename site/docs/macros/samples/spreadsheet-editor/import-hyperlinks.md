...
(function () {
  ...
  worksheetA.GetRange("B1").SetValue("https://api.maticonoffice.ru/docs/office-api/usage-api/spreadsheet-api/");
  worksheetA.GetRange("B2").SetValue("https://api.maticonoffice.ru/docs/office-api/usage-api/document-api/");
  worksheetA.GetRange("B3").SetValue("https://api.maticonoffice.ru/docs/office-api/usage-api/presentation-api/");
