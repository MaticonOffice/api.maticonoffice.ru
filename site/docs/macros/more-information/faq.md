...
Maticon Office macros use JavaScript syntax and [Office JavaScript API](../../office-api/get-started/overview.md) scripting notation. Any method available in JavaScript and all methods supported by Office API are also available in macros.

## How do I run a macro?

1. Open Maticon Office Desktop Editors or Maticon Office Docs.
...
Use the `debugger` keyword as a breakpoint in your script and open the browser developer console (**F12**). For Maticon Office Desktop Editors, follow the [platform-specific debug instructions](../../desktop-editors/usage-api/debugging.md). See the full [Debugging](../guides/debugging.md) page for details.

## Can I use my Microsoft Office (VBA) macros in Maticon Office?

Not directly, because Maticon Office macros use JavaScript while Microsoft Office macros use Visual Basic for Applications (VBA). You can convert them in two ways:
