...
Base class used by Maticon Office Document Builder for the document file (document, spreadsheet, presentation, form document, PDF) to be generated.
...
| [Dispose](Dispose.md)                                       | Unloads the Maticon Office Document Builder from the application memory when it is no longer needed. *(not used in .Net)*                      |
| [Destroy](Destroy.md)                                       | Unloads the Maticon Office Document Builder from the application memory when it is no longer needed. *(.Net only)*                             |
...
| [GetVersion](GetVersion.md)                                 | Returns the Maticon Office Document Builder engine version. *(not used in COM)*                                                                |
| [Initialize](Initialize.md)                                 | Initializes the Maticon Office Document Builder as a library for the application to be able to work with it.                                   |
...
| [Run](Run.md)                                               | Runs the Maticon Office Document Builder executable.                                                                                           |
