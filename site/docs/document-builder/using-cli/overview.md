...
You can use **Maticon Office Document Builder** to generate documents from **.js** script files via the command line (CLI). To launch it, run:
...
For examples of using Document Builder CLI on servers with different programming languages (C#, Node.js, PHP, Ruby), see the [document-builder-integration](https://github.com/MaticonOffice/document-builder-integration) repository.
:::
