...
1. Maticon Office Document Builder is installed. For more information visit [installing page](/docs/document-builder/get-started/installing.md).
2. The directory in which you are going to store the downloaded samples has general editing access to save files created by the Document Builder.

## Hello world sample

This section will help you build the "Hello World" application. It is easy to integrate the **Maticon Office Document Builder SDK** if you are able to open, save and close documents.
...
// for linux is builder/opt/maticonoffice/documentbuilder, for windows and mac is builder
...
<Tabs>
    ...
    ```bash
    g++ hello-world.cpp \
        -Ibuilder/opt/maticonoffice/documentbuilder/include \
        -Lbuilder/opt/maticonoffice/documentbuilder \
        -lDocxRenderer \
        -ldoctrenderer \
        -lstdc++ -lpthread -lm -lc \
        -Wl,-rpath=builder/opt/maticonoffice/documentbuilder \
        -o hello-world
    ```
    - Run the application via
    ```bash
...
Clone a repository with the Document Builder samples from [https://github.com/MaticonOffice/document-builder-samples](https://github.com/MaticonOffice/document-builder-samples). The created folder must have general editing access.
