...
## How to install Maticon Office Desktop Editors?

Maticon Office Desktop Editors is available for Windows, Linux and macOS. Starting from version 6.1, this application is also supported by ARM-based Apple Silicon Macs.

The simplest way to install this application on your local computer is to download it from our official [website](https://www.maticonoffice.ru/download-desktop.aspx).

For some Linux distributions, like Zorin OS, Linux Mint, Linkat, Linspire, etc., the Maticon Office Desktop Editors package is already pre-installed or available on their official stores.
...
In this way, you can add the DMS provider only to your own connection list. If you want to add it for all the users, submit a feature request [on GitHub](https://github.com/MaticonOffice/DesktopEditors/issues).
...
- delete the *cloud\_crypto.xml* file from the *sdkjs-plugins* directory. The path to the folder depends on the operating system you use:
  ...
  - For Linux - *home/\<username>/.local/share/maticonoffice/desktopeditors/sdkjs-plugins/*
  - For Windows - *C:\Users\\\<username>\AppData\Local\Maticon Office\DesktopEditors\data\sdkjs-plugins\\*
