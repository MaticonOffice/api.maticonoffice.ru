...
Maticon Office Desktop Editors supports command-line flags that let you control how the application launches and behaves. Pass a flag by appending it to the executable path when starting the application.
...
```
"%ProgramFiles%\Maticon Office\DesktopEditors\DesktopEditors" <flag>
```
...
```bash
"/opt/maticonoffice/desktopeditors/DesktopEditors" <flag>
```
...
```bash
"/Applications/Maticon Office.app/Contents/MacOS/Maticon Office" <flag>
```
...
| `--custom-title-bar` | Linux | Uses the Maticon Office title bar; overrides `--system-title-bar`. |
...
```
"%ProgramFiles%\Maticon Office\DesktopEditors\DesktopEditors" --review="C:\Users\username\Documents\Document1.docx"
```
...
```bash
"/opt/maticonoffice/desktopeditors/DesktopEditors" --review="/home/username/Documents/Document1.docx"
```
...
```
"%ProgramFiles%\Maticon Office\DesktopEditors\DesktopEditors" --edit="C:\Users\username\Documents\Document1.docx"
```
...
```bash
"/opt/maticonoffice/desktopeditors/DesktopEditors" --edit="/home/username/Documents/Document1.docx"
```
...
```
"%ProgramFiles%\Maticon Office\DesktopEditors\DesktopEditors" --view="C:\Users\username\Documents\Document1.docx"
```
...
```bash
"/opt/maticonoffice/desktopeditors/DesktopEditors" --view="/home/username/Documents/Document1.docx"
```
...
```
"%ProgramFiles%\Maticon Office\DesktopEditors\DesktopEditors" --review="C:\Users\username\Documents\Document1.docx" --force-use-tab
```
...
```bash
"/opt/maticonoffice/desktopeditors/DesktopEditors" --review="/home/username/Documents/Document1.docx" --force-use-tab
```
