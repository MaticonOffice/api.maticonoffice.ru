...
You can create custom interface themes for Maticon Office Desktop Editors by adding JSON configuration files to the themes directory.
...
<Tabs>
    <TabItem value="windows" label="Windows">
        ``` bash
        copy C:\path\theme-file.json "%ProgramFiles%\Maticon Office\DesktopEditors\web-apps\apps\common\main\resources\themes"
        ```
    </TabItem>
    <TabItem value="linux" label="Linux">
        ``` bash
        cp /path/theme-file.json /opt/maticonoffice/desktopeditors/web-apps/apps/common/main/resources/themes
        ```
    </TabItem>
    <TabItem value="macos" label="macOS">
        ``` bash
        cp /path/theme-file.json "/Applications/Maticon Office.app/Contents/Resources/web-apps/apps/common/main/resources/themes"
        ```
    </TabItem>
</Tabs>
