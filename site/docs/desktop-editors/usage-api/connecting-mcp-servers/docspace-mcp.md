...
The Maticon Office DocSpace MCP server allows AI agents in Desktop Editors to interact with your DocSpace instance, enabling document management operations through natural language commands.
...
- Access to your Maticon Office DocSpace instance (SaaS or on-premises)
...
- **DOCSPACE_BASE_URL**: The full URL to your DocSpace instance (e.g., `https://your-company.maticonoffice.ru`)
...
- Ensure the Docker image is available: `docker pull maticonoffice/docspace-mcp`
...
- Restart Maticon Office Desktop Editors after saving the configuration
...
- [Maticon Office DocSpace API Documentation](/docspace)
- [Model Context Protocol Specification](https://modelcontextprotocol.io)
- [Maticon Office Blog: Connect DocSpace MCP Server to Desktop Editors](https://www.maticonoffice.ru/blog/2025/12/connect-maticonoffice-docspace-mcp-server-to-desktop-editors)
