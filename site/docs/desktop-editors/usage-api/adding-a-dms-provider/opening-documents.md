...
Connecting Maticon Office Desktop Editors to your cloud allows you to edit documents, spreadsheets, presentations, PDFs, and fillable forms without having a constant Internet connection and easily switch to the online mode for real-time co-editing (in case [Maticon Office Docs](../../../docs-api/get-started/basic-concepts.md) is integrated with your cloud).

Besides, using Maticon Office Desktop Editors you are no longer limited by your browser resources. It means you can:
...
| provider  | string | `"maticonoffice"`                                     | The provider id used to refer to the desktop app in the JavaScript commands (the same as in the [config](./adding-a-dms-provider.md)). |
