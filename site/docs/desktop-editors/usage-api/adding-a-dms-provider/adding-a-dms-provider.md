...
Maticon Office Desktop Editors allows users to access the documents from the cloud and collaborate on them with their teammates. In this case, an Internet connection is required. Currently, users can connect the application to Maticon Office DocSpace (SaaS or on-premises), Nextcloud, ownCloud, Moodle, Liferay, kDrive, or Seafile, but you can extend this list adding your own DMS.

Follow the steps below to add your own document management system (DMS) to the connection list:

## Step 1

Create a folder using the DMS provider as a name (e.g. *maticonoffice*) in the *providers* directory. The path to the folder depends on the operating system you use:

<Tabs>
  <TabItem value="win" label="Windows">
    ``` bash
    %ProgramFiles%\Maticon Office\DesktopEditors\providers\
    ```
  </TabItem>
  <TabItem value="mac" label="macOS">
    ``` bash
    /Applications/Maticon Office.app/Contents/Resources/providers/
    ```
  </TabItem>
  <TabItem value="lin" label="Linux">
    ``` bash
    /opt/maticonoffice/desktopeditors/providers/
    ```
  </TabItem>
</Tabs>
...
|-----------------------|------------------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| provider              | string                 | `"maticonoffice"`                                                                                              | The provider id used to refer to the desktop app in the JavaScript commands.                                                                                              |
| name                  | string                 | `"Maticon Office"`                                                                                              | The name displayed in the provider choice section when adding a cloud.                                                                                                    |
...
| editorPage            | string                 | `"/apps/maticonoffice/"` or `"regex:\/lib\/(?:[\w-]{32,})\/file\/"`                                            | The relative URL that indicates that the type of the opening file is a document. You can use regular expressions for this parameter.                                      |
...
1. Launch Maticon Office Desktop Editors or restart it if needed.
