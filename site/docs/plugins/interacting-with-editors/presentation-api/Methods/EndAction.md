...
:::note
GroupActions are available only for [Maticon Office Docs Enterprise](https://www.maticonoffice.ru/docs-enterprise-prices.aspx?from=api) and [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api).
:::
