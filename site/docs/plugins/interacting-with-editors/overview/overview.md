...
Any plugin has the [Asc.plugin](asc-plugin.md) object which provides methods and events to interact with Maticon Office document, spreadsheet, presentation, and PDF editors.
