...
`window.Asc.plugin` is the main object of the Maticon Office Plugin SDK. It is available in every plugin and provides methods, properties, and events for interacting with the editor.
