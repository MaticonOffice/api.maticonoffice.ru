...
Once your plugin is published in the Maticon Office Plugin Marketplace, you will need to release updates to fix bugs, add features, or maintain compatibility with new Maticon Office versions.

## Versioning scheme

Maticon Office plugins use semantic versioning (`MAJOR.MINOR.PATCH`):
...
## Specifying minimum Maticon Office version
...
```bash
git remote add upstream https://github.com/MaticonOffice/maticonoffice.github.io.git
git fetch upstream
git checkout master
...
Include in PR description: what changed, new Maticon Office version requirements, bug fixes or breaking changes.
...
## Handling Maticon Office version compatibility

Test after each Maticon Office release:
- All `executeMethod` calls return expected results
- Event handlers fire correctly
- UI elements render correctly

Check the [Changelog](../../more-information/changelog.md) after each Maticon Office release.
...
Open an issue at [https://github.com/MaticonOffice/maticonoffice.github.io/issues](https://github.com/MaticonOffice/maticonoffice.github.io/issues) with the plugin name and reason.
...
- [Marketplace repo](https://github.com/MaticonOffice/maticonoffice.github.io)
- [Plugin examples](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content)
