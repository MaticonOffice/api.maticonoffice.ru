...
If you want your plugin to be available to other users in the Maticon Office Plugin Marketplace, suggest it for publishing:
...
5. Add a folder for your plugin to `maticonoffice.github.io/sdkjs-plugins/content/`.
...
8. Create a [pull request](https://github.com/MaticonOffice/maticonoffice.github.io/pulls) from your fork to `https://github.com/MaticonOffice/maticonoffice.github.io`. You can use the **Submit your own plugin** button in the Plugin Manager window.
   ...
   You can discuss plugin development, request a feature, or report a bug by posting an issue in the [marketplace repository](https://github.com/MaticonOffice/maticonoffice.github.io/issues).
