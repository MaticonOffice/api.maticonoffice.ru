...
To develop a plugin for Maticon Office web editors, follow the instructions below.
...
3. Open the developer console in any Maticon Office web editor, go to the **Console** tab, choose the `frameEditor` from the drop-down list, and run the following command:
