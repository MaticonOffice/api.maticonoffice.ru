...
# Maticon Office Desktop Editors
...
<Tabs>
  <TabItem value="win" label="Windows">
      ``` bash
      %ProgramFiles%\Maticon Office\DesktopEditors\editors\sdkjs-plugins\
      ```
  </TabItem>
  ...
  <TabItem value="lin" label="Linux">
      ``` bash
      /opt/maticonoffice/desktopeditors/editors/sdkjs-plugins/
      ```
  </TabItem>
</Tabs>
...
**Step 4.** Start [Maticon Office Desktop Editors](../../../desktop-editors/get-started/overview.md). If everything is done correctly, the plugin will be displayed within the **Plugins** tab:
...
:::caution
Please note that removing the default plugins from Maticon Office Desktop Editors on macOS breaks the package integrity and may cause the application crash. Be careful and don't do this unless absolutely necessary.
:::
