...
The complete translations in the [config.json](configuration.md) for the [highlighting plugin code](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/highlightcode) will look the following way:
...
Error output: Silent English fallback / Maticon Office takes the default language as English, and no error occurs.
