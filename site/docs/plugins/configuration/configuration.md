...
Specifies whether the plugin is included in the server or desktop builds branded as Maticon Office.
...
The description, i.e. what describes your plugin the best way. It will be displayed in the **Maticon Office Plugin Marketplace**.
...
Plugin screenshot image files used in the **Maticon Office Plugin Marketplace** for the plugin description.
...
Plugin display options in **Maticon Office Plugin Marketplace**.
...
Background colors used for plugin icons in **Maticon Office Plugin Marketplace**.
...
Plugin categories in **Maticon Office Plugin Marketplace**:
...
Paths to the plugin icon image files used in the **Maticon Office Plugin Marketplace**.
...
Images that are used for the plugin description in the **Maticon Office Plugin Marketplace**.
