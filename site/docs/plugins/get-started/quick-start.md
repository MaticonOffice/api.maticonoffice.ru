...
This file tells Maticon Office about your plugin:
...
<head>
    ...
    <script src="https://maticonoffice.github.io/sdkjs-plugins/v1/plugins.js"></script>
    <style>
        body {
...
### For Maticon Office Desktop Editors

1. Open Maticon Office Desktop.
...
### For Maticon Office Docs (on-premises)

1. Copy your plugin folder to the server plugins directory:
   - Linux: `/var/www/maticonoffice/documentserver/sdkjs-plugins/`
   - Windows: `C:\Program Files\Maticon Office\DocumentServer\sdkjs-plugins\`
...
1. Open a document in Maticon Office.
