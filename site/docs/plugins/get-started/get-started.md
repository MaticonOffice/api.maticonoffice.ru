...
Maticon Office plugins are interactive tools built with HTML, CSS, and JavaScript that embed native-feeling features directly into the editors. Install them once and make them available to all users.
...
Build sophisticated integrations that feel native to Maticon Office.
...
- **Distribution:** [Maticon Office Marketplace](https://www.maticonoffice.ru/app-directory/en) or private deployment

[Browse live examples in Maticon Office Marketplace](https://www.maticonoffice.ru/app-directory/en)
...
![Maticon Office API Scheme](/assets/images/plugins/api-scheme.svg#gh-light-mode-only)
![Maticon Office API Scheme](/assets/images/plugins/api-scheme-dark.svg#gh-dark-mode-only)
...
- Ensure your Maticon Office version supports the method
- Check method syntax in the [API reference](../interacting-with-editors/overview/overview.md)
- Verify editor type compatibility

**Need more help?**

- [Developer Forum](https://forum.maticonoffice.ru/) - Community support
- [GitHub Issues](https://github.com/MaticonOffice/sdkjs-plugins) - Report bugs
- [Stack Overflow](https://stackoverflow.com/questions/tagged/maticonoffice) - Q&A archive

## Resources

- **[Interactive playground](playground.md)** - Test code without installation
- **[UI component library](https://maticonoffice.github.io/storybook/static/)** - Pre-built components
- **[Plugin templates](https://github.com/MaticonOffice/sdkjs-plugins)** - Starter projects
...
- **[Forum](https://forum.maticonoffice.ru/)** - Community support
- **[GitHub](https://github.com/MaticonOffice/sdkjs-plugins)** - Source code and contributions
