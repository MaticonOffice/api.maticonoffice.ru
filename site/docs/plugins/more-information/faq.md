...
## How to install plugins to the Maticon Office editors?
...
## How to adjust my plugin to the Maticon Office style?

Maticon Office offers its own style sheet in the [plugin.css](https://maticonoffice.github.io/sdkjs-plugins/v1/plugins.css) file connected to the *index.html* file. Detailed instructions on connecting Maticon Office styles to the editors can be found [here](../configuration/styles-and-theming.md).
...
Use the [plugin variations](../configuration/variations.md) or *subplugins* to create an **About** window for your plugin or add extra plugin settings. Have a look at the plugin example with two variations [here](https://github.com/MaticonOffice/sdkjs-plugins/tree/master/helloworld). In addition to two variations in the config, you also need to create an additional *index\_about.html* file.

## Where to find the existing plugins available for integration?

All ready-to-use plugins are available in the [Maticon Office App Directory](https://www.maticonoffice.ru/app-directory/en).

More plugin samples are listed [on GitHub](https://github.com/MaticonOffice/sdkjs-plugins). Feel free to fork them and use them as examples to create your own plugin.
...
## Can I use Microsoft Office macros in Maticon Office editors?

Microsoft Office macros use Visual Basic for Applications (VBA) scripting language, while Maticon Office editors use JavaScript. But this is not difficult to convert your previously used macros into the new format. Some examples of converting MS VBA macros you can see [here](../../macros/guides/converting-vba-macros.md).
