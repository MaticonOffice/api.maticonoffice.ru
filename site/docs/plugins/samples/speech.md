...
Available by default in Maticon Office Enterprise Edition and Community Edition (Docs + Workspace), and Maticon Office cloud.

You can also download this plugin from the [Maticon Office App Directory](https://www.maticonoffice.ru/app-directory/en/speech).
...
Repository on GitHub: [speech](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/speech).
...
5. Third-party services:
   ...
   - [jQuery](https://jquery.com) - a fast and concise JavaScript Library that simplifies HTML document traversing, event handling, animating, and Ajax interactions for rapid web development. License: [MIT License](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/speech/licenses/jQuery.license).
   - [Select2](https://select2.org/) gives you a customizable select box with support for searching, tagging, remote data sets, infinite scrolling, and many other highly used options. License: [MIT](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/speech/licenses/Select2.license).
