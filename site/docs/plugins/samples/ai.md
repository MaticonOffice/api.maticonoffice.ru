...
Connects an AI provider (e.g., OpenAI, DeepSeek) to Maticon Office editors, enabling intelligent text generation, editing, summarization, and automatic macro creation.
...
Available by default in Maticon Office Enterprise Edition, Community Edition (Docs + Workspace), and Maticon Office cloud.

You can also download this plugin from the [Maticon Office App Directory](https://www.maticonoffice.ru/app-directory/en/ai) and install it following the [desktop](../development-workflow/installing-and-testing/desktop-editors-installation.md) installation instructions.

Starting from version 9.0.4, the AI plugin was added to the server and desktop distributions built with Maticon Office branding.
...
3. Find a new **AI** tab in the top toolbar of Maticon Office editors.
...
For details on adding a custom provider, refer to this [blog post](https://www.maticonoffice.ru/blog/2025/03/how-to-add-a-custom-provider-to-the-maticonoffice-ai-plugin).

## Plugin structure

Repository on GitHub: [ai](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/ai).
