...
Add an AI-generated comment or footnote to selected text using the Maticon Office AI agent.
...
6. Prepare your custom store URL: `https://YOUR-USERNAME.github.io/maticonoffice.github.io/store/index.html`

## Step 7: Test your custom AI tool

1. In Maticon Office, go to **Plugins → Plugin Manager**.
...
- [Getting started with Maticon Office AI agent](../guides/ai-agent.md)
