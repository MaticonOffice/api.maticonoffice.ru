...
To add a custom provider and display it in the list of available providers within the AI plugin, create and upload an external JS file. An example of such a file can be found [here](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/ai/scripts/engine/providers/internal/openai.js).

Custom providers parsed from this file are instances of the [`Provider`](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/ai/scripts/engine/providers/provider.js) class, which extends `AI.Provider`. This class manages all available providers within the plugin.
