...
AI is a background plugin that connects an AI provider (e.g., OpenAI, DeepSeek) to Maticon Office editors, enabling intelligent text generation, editing, summarization, and automatic macro creation.
...
If you need to add it manually, download this plugin from the [Maticon Office App Directory](https://www.maticonoffice.ru/app-directory/en/ai) and install it following the [desktop](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md), [on-premises](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md), or [cloud](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md) installation instructions.
...
1. Open the **AI** tab in the top toolbar of Maticon Office editors.
