...
- [`editorConfig`](./config/editor/editor.md) - defines the editor interface parameters: opening mode, language, callback URL, etc.;
  ...
  - [`plugins`](./config/editor/plugins.md) - connects [plugins](../../plugins/get-started/get-started.md) to Maticon Office Docs for all editor users;
...
Replace `example.com` with the host of your **document storage service**. See the [How it works](../get-started/how-it-works/how-it-works.md) section to find out more on Maticon Office Docs service client-server interactions.
