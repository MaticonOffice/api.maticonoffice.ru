...
| Parameter                    | Type   | Description              |
| ---------------------------- | ------ | ------------------------ |
| event.data.errorCode         | `number` | The [error code](https://github.com/MaticonOffice/sdkjs/blob/master/common/errorCodes.js).          |
...
:::note
This event is available only for [Maticon Office Docs Enterprise](https://www.maticonoffice.ru/docs-enterprise-prices.aspx?from=api) and [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api).
:::
:::danger[Deprecated]
...
| Parameter                      | Type   | Description                |
| ------------------------------ | ------ | -------------------------- |
| event.data.warningCode         | `number` | The [warning code](https://github.com/MaticonOffice/sdkjs/blob/master/common/errorCodes.js).          |
