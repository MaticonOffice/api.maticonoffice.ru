...
The absolute URL to the **document storage service**. This service [must be implemented](../../callback-handler.md) by the software integrators who use Maticon Office Docs on their own server.
