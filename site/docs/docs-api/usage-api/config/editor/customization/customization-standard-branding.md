...
:::info
Most parameters on this page are available for all Maticon Office Docs editions, including the open-source community version. Some parameters are available only for [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api) and are marked accordingly. If you have an extended white label license, please visit the [White label page](customization-white-label.md) for additional customization options.
:::
...
:::info
This parameter is available only for [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api).
:::
...
The **example.com** is the name of the server where **document manager** and **document storage service** are installed. See the [How it works](../../../../get-started/how-it-works/how-it-works.md) section to find out more on Maticon Office Docs service client-server interactions.
