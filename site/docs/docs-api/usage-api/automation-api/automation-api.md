...
Automation API enables interaction with office documents from external sources through custom interface elements. Build your own UI components while leveraging Maticon Office document processing — manage comments, control review workflows, auto-fill forms, and more, all from outside the editor.

:::info
Automation API is available only for **Maticon Office Docs Developer**.

This is a premium feature not included by default and is available at an extra cost. Please contact our sales team at [sales@maticonoffice.ru](mailto:sales@maticonoffice.ru) to request a quote, or learn more at [maticonoffice.ru/automation-api](https://www.maticonoffice.ru/automation-api).
:::
