...
:::note
Please note that the connector is available only for **Maticon Office Docs Developer**.

The connector is an additional feature not included by default in the Maticon Office Docs Developer and is available at an extra cost. Please contact our sales team at [sales@maticonoffice.ru](mailto:sales@maticonoffice.ru) to request a quote.
:::
