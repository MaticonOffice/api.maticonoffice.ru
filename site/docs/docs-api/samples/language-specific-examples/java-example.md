---
sidebar_position: -8
description: Integrate Maticon Office Docs into a Java web application.
...
This example will help you integrate Maticon Office Docs into your web application written in Java.
...
<Tabs>
    <TabItem value="windows" label="Windows">
        ...
        Download the archive with the Java example and unpack the archive, or get the source code directly from [GitHub](https://github.com/MaticonOffice/document-server-integration/tree/master/web/documentserver-example/java):
        ...
        where the `documentserver` is the name of the server with the Maticon Office Docs installed and the `storage-folder` is the path where files will be created and stored. You can set an absolute path. For example, `D:\\folder`. Please note that on Windows OS the double backslash must be used as a separator. You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console.
        ...
        Open the *src/main/resources/settings.properties* file and [specify the same secret key](https://help.maticonoffice.ru/installation/docs-configure-jwt.aspx) as used in your Maticon Office Docs to enable JWT:
        ...
        In case the example and Maticon Office Docs are installed on different computers, make sure that your server with the example installed has access to the Maticon Office Docs with the address which you specify instead of `documentserver` in the configuration files. Make sure that the Maticon Office Docs in its turn has access to the server with the example installed with the address which you specify instead of `example.com` in the configuration files.
    </TabItem>
    <TabItem value="linux" label="Linux">
        ...
        Edit the *src/main/resources/settings.properties* configuration file. Specify the name of your local server with the Maticon Office Docs installed.
        ...
        where the `documentserver` is the name of the server with the Maticon Office Docs installed and the `storage-folder` is the path where files will be created and stored. You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console. Please note that you must have read and write permissions to the folder. If you do not have them, please use the next command:
    ...
    <TabItem value="docker" label="Docker">
        ...
        Edit the *src/main/resources/settings.properties* configuration file. Specify the name of your local server with Maticon Office Docs installed:
        ...
        where the `documentserver` is the name of the server with the Maticon Office Docs installed and the `storage-folder` is the path where files will be created and stored. You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console.
