...
## How to whitelabel Maticon Office Docs?

The below options can be edited for whitelabeling your version of Maticon Office Docs, changing the information which will be displayed at the **About** page and visible to all editor users.

:::note
Changing these options is only available to the [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx) users.
:::
...
## How to change the default language of the Maticon Office Docs interface?

If the interface language is present in the [list of available Maticon Office Docs languages](https://help.maticonoffice.ru/docs/docs-available-languages.aspx?from=api), you can simply use the *editorConfig.lang* property in the configuration file to set it to the necessary locale, like this:
...
If the language is not available and you want to translate it or have already translated it to your own language, please see [this article](https://help.maticonoffice.ru/docs/installation/docs-community-add-language-docker.aspx?from=api) to find out how to install it to your Maticon Office Docs.
...
## How to connect plugins to Maticon Office Docs so that they become visible for all editor users?

To enable plugins for all Maticon Office Docs users, you need the following:

- Get the plugins (this can be done using our plugin repository on [GitHub](https://github.com/MaticonOffice/sdkjs-plugins) or you can write your own plugin).
...
Where *editorConfig.plugins.autostart* is the array of the GUIDs for the plugins that you want to start automatically when Maticon Office Docs is started (as defined in the plugin [config.json](../../../plugins/configuration/configuration.md#guid) file), and *editorConfig.plugins.pluginsData* is the array of the **config.json** configuration files for all the plugins that you want to be available to Maticon Office Docs users.

Further information about enabling the plugins for Maticon Office Docs can be found [at this page](../../usage-api/config/editor/plugins.md).
...
:::note
These parameters are available only for the [extended white label license](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api) of Maticon Office Docs Developer.
:::
