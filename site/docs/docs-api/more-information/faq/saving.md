...
- Enabling the repeating forcesave start in the **default.json** Maticon Office Docs configuration file:
...
Please see the [Saving file](../../get-started/how-it-works/saving-file.md) section to find out how file saving works in Maticon Office Docs and what is needed to save the created document.
...
The time between the end of the editing and the conversion start is set in the **default.json** configuration file with the [services.CoAuthoring.server.savetimeoutdelay](https://help.maticonoffice.ru/installation/docs-developer-configuring.aspx#services-CoAuthoring-server-savetimeoutdelay) parameter (5000 milliseconds or 5 seconds by default) and can be changed:
