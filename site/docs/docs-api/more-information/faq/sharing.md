...
To open the document with the *track changes* mode enabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
To open the document with the *commenting* mode enabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
With the configuration above the document will be opened with the form filling mode enabled and all the other modes disabled, giving the users who have access to it only the possibility to fill the fields in the special [content controls](https://help.maticonoffice.ru/Maticon Office-Editors/Maticon Office-Document-Editor/UsageInstructions/InsertContentControls.aspx?from=api).
...
To open the document with both the *editing* and the *commenting* modes enabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
To open the document with both the *viewing* mode enabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
To open the document with the *downloading* option disabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
To open the document with the *printing* option disabled, the *document.permissions* parameter is used (see the complete structure of Maticon Office Docs configuration object [here](../../usage-api/advanced-parameters.md)).
...
The *document.info.sharingSettings.user* is a string parameter, which can display any user name passed from the **document storage service** to the Maticon Office Docs.
