...
| token     | string  | required by configuration | The encrypted signature added to the **Maticon Office Docs** config in the form of a [token](./signature/request/token-in-body.md#document-builder).                                                                                                                                                                                                                                                                                                                                                                     |
...
:::info
In the examples below, `example.com` represents the server where your **document storage service** is installed and `.js` files are served from. See the [How it works](../get-started/how-it-works/how-it-works.md) section to learn more about Maticon Office Docs service client-server interactions.
:::
