...
:::note
In the [maticonoffice-docs-formats.json](https://github.com/MaticonOffice/document-formats/blob/master/maticonoffice-docs-formats.json) file, you can find a list of all file formats supported by Maticon Office editors with their properties (possible actions, MIME, etc.).
:::
