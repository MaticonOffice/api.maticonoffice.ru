...
The figure and steps below explain how a document is opened in Maticon Office Docs.
...
3. Include the Maticon Office Docs JavaScript API script on your page:

   ``` html
   <script type="text/javascript" src="https://documentserver/web-apps/apps/api/documents/api.js"></script>
   ```

   Where `documentserver` is the name of the server where Maticon Office Docs is installed. The `api.js` script is served by the **document editing service**; it loads the **document editor** and connects it to that same service.
