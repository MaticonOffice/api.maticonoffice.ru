...
The figure and steps below explain how a document is co-edited in Maticon Office Docs.
...
:::note
In every example below, replace `example.com` with the host serving your document file — i.e., your **document storage service**. For a quick test, use `https://static.maticonoffice.ru/assets/docs/samples/demo.docx` as the `url`.
:::
