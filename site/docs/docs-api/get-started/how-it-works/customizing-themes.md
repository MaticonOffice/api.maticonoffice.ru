...
You can create custom interface themes for Maticon Office Docs by adding JSON configuration files to the themes directory on the server.
...
<Tabs>
    <TabItem value="docker" label="Docker">
        ``` bash
        sudo docker cp /path/theme-file.json {container_id}:/var/www/maticonoffice/documentserver/web-apps/apps/common/main/resources/themes
        ```
    </TabItem>
    <TabItem value="linux" label="Linux">
        ``` bash
        cp /path/theme-file.json /var/www/maticonoffice/documentserver/web-apps/apps/common/main/resources/themes
        ```
    </TabItem>
    <TabItem value="windows" label="Windows">
        ``` bash
        copy C:\path\theme-file.json "%ProgramFiles%\Maticon Office\DocumentServer\web-apps\apps\common\main\resources\themes"
        ```
    </TabItem>
</Tabs>
