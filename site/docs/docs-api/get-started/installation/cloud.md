...
To install Maticon Office Docs in the cloud:

1. Deploy Maticon Office Docs Developer solution in the cloud by filling in the registration [form](https://www.maticonoffice.ru/docs-registration.aspx?from=api) on our official website.
...
3. Specify the page code containing the changeable parameters:
   ...
   Where **example.com** is the public IP address or public DNS provided by your cloud where **document manager** and **document storage service** are installed. You can use the URL `https://static.maticonoffice.ru/assets/docs/samples/demo.docx` of our sample document for testing. See the [How it works](/docs/docs-api/get-started/how-it-works/how-it-works.md) section to find out more on Maticon Office Docs service client-server interactions.
