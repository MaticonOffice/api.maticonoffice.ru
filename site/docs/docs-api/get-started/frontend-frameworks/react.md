...
The Maticon Office Docs React [component](https://github.com/MaticonOffice/document-editor-react) integrates Maticon Office Docs into [React](https://react.dev/) projects.
...
This procedure creates a [basic React application](https://github.com/facebook/create-react-app) and installs an Maticon Office Docs editor in it.
...
3. Install Maticon Office Docs React component from **npm** and save it to the *package.json* file with *--save*:
...
4. Open the *./src/App.js* file in the *maticonoffice-react-demo* project and replace its contents with the following code:
   ...
   This JavaScript file will create the *App* component containing the Maticon Office Docs editor configured with basic features.
...
## Maticon Office Docs React component API
...
1. Change the address of the document server in the *config/default.json* file:
   ...
   where **documentserver** is the name of the server with **Maticon Office Docs** installed. You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console.
...
## Developing Maticon Office Docs React component
...
In case you have any issues, questions, or suggestions for the Maticon Office Docs React component, please refer to the [Issues](https://github.com/MaticonOffice/document-editor-react/issues) section.
