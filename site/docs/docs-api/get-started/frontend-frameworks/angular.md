...
The Maticon Office Docs Angular [component](https://github.com/MaticonOffice/document-editor-angular-workspace) integrates Maticon Office Docs into [Angular](https://angularjs.org/) projects.

## Prerequisites

This procedure requires [Node.js (and npm)](https://nodejs.org/en).

## Creating the demo Angular application with Maticon Office Docs editor

This procedure creates a [basic Angular application](https://angular.io/guide/setup-local) and installs an Maticon Office Docs editor in it.
...
2. Create a new Angular project named *maticonoffice-angular-demo*:

   ``` sh
   ng new --defaults --skip-git maticonoffice-angular-demo
   ```

3. Go to the newly created directory:

   ``` sh
   cd maticonoffice-angular-demo
   ```

4. Install Maticon Office Docs Angular component from **npm** and save it to the *package.json* file with *--save*:

   ``` sh
   npm install --save @maticonoffice/document-editor-angular
   ```

   You can also use the following **yarn** command:

   ``` sh
   yarn add @maticonoffice/document-editor-angular
   ```
...
1. Open the *./src/app/app.module.ts* file in the *maticonoffice-angular-demo* project and import the **DocumentEditorModule**:

   ``` ts
   import {NgModule} from "@angular/core";
   import {BrowserModule} from "@angular/platform-browser";
   import {DocumentEditorModule} from "@maticonoffice/document-editor-angular";
...
2. Open the *./src/app/app.component.ts* file in the *maticonoffice-angular-demo* project and define options in your consuming component:

   ``` ts
   import {Component} from "@angular/core";
   import {type IConfig} from "@maticonoffice/document-editor-angular";
   ...
   - `https://example.com/url-to-example-document.docx` - replace with the URL to your file. You can use the URL `https://static.maticonoffice.ru/assets/docs/samples/demo.docx` of our sample document for testing.
   - `https://example.com/url-to-callback` - replace with your callback URL (this is required for the saving functionality to work).

   This TypeScript file will create the *AppComponent* component containing the Maticon Office Docs editor configured with basic features.
...
3. In template, use the *document-editor* component with your options:
   ...
   Replace the `http://documentserver/` line with the URL of your server. You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console.

### Versions 17.0.0 and above

1. Open the *./src/app/app.component.ts* file in the *maticonoffice-angular-demo* project and define options in your consuming component:
   ...
   ``` ts
   import {Component} from "@angular/core";
   import {DocumentEditorModule, type IConfig} from "@maticonoffice/document-editor-angular";
...
- To start the development server, navigate to the *maticonoffice-angular-demo* directory and run:
...
1. Navigate to the *maticonoffice-angular-demo* directory and run:
...
2. Copy the contents of the *dist/maticonoffice-angular-demo* directory to the root directory of the web server (to the *maticonoffice-angular-demo* folder).

The application will be deployed on the web server (`http://localhost:3000` by default).

## Maticon Office Docs Angular component API
...
| documentServerUrl\*                  | string                  | null    | Address of Maticon Office Docs.                                                                                                                                |
...
## Developing Maticon Office Docs Angular component

1. Clone project from the GitHub repository:

   ``` sh
   git clone https://github.com/MaticonOffice/document-editor-angular-workspace.git
   ```
...
3. Build the project:
   ...
   ng build @maticonoffice/document-editor-angular
   ```

4. Create the package:

   ``` sh
   cd ./dist/maticonoffice/document-editor-angular
...
5. Test the component:
   ...
   ng test @maticonoffice/document-editor-angular
   ```

## Feedback and support

In case you have any issues, questions, or suggestions for the Maticon Office Docs Angular component, please refer to the [Issues](https://github.com/MaticonOffice/document-editor-angular-workspace/issues) section.
