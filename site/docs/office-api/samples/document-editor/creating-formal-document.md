...
let run2 = paragraph2.AddText("Maticon Office");
run2.AddLineBreak();
...
paragraph.AddText("After years of market research and focused creative effort we are in a position to take our 'Maticon Office Document Builder' to market. We have a three phase approach in place to complete the product and take the product to market.  The first step of this initiative is to test the market. ");
doc.Push(paragraph);
...
paragraph2 = Api.CreateParagraph();
paragraph2.SetJc("left");
run2 = paragraph2.AddText("After years of market research and focused creative effort we are in a position to take our 'Maticon Office Document Builder' to market.");
run2.SetFontSize(18);
run2.SetItalic(true);
run2.SetColor(0, 0, 0);
run2.SetFontFamily("Calibri");
...
if (row) {
  ...
  if (cell) {
    ...
    run = paragraph.AddText("Maticon Office Document Builder");
...
if (row) {
  ...
  if (cell) {
    ...
    paragraph.SetJc("right");
    paragraph.AddText("Maticon Office Document Builder");
  ...
  if (cell) {
    ...
    paragraph.SetStyle(footerStyle);
    paragraph.SetJc("right");
    drawing = Api.CreateImage("https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png", 495_300, 481_965);
