...
```ts editor-forms zoom=60 templateUrl=https://static.maticonoffice.ru/assets/docs/samples/purchase_order.pdf
let doc = Api.GetDocument();

let data = {
  "Photo": "https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png",
  "Serial": "A1345",
  "Company Name": "Maticon Office",
  "Date": "25.12.2023",
