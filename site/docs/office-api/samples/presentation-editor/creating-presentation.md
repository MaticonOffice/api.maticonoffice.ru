...
let image_url = "https://static.maticonoffice.ru/assets/docs/samples/img/presentation_gun.png";
...
presentation.AddSlide(slide);
let fill = Api.CreateBlipFill("https://static.maticonoffice.ru/assets/docs/samples/img/presentation_axe.png", "stretch");
slide.SetBackground(fill);
slide.RemoveAllObjects();
...
slide = Api.CreateSlide();
presentation.AddSlide(slide);
fill = Api.CreateBlipFill("https://static.maticonoffice.ru/assets/docs/samples/img/presentation_knight.png", "stretch");
slide.SetBackground(fill);
slide.RemoveAllObjects();
...
slide = Api.CreateSlide();
presentation.AddSlide(slide);
fill = Api.CreateBlipFill("https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png", "stretch");
slide.SetBackground(fill);
slide.RemoveAllObjects();
...
content = shape.GetDocContent();
content.RemoveAllElements();
addText(shape, content, "Maticon Office", 176, false, "center");
