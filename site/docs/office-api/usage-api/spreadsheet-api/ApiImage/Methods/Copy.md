...
:::note
This functionality is available in paid Maticon Office Docs editions.
:::
...
let image = worksheet.AddImage('https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png', 60 * 36000, 35 * 36000, 0, 2 * 36000, 2, 3 * 36000);
