...
The simplest example form document with a single text form containing the "John Smith" text can be built with the help of **Maticon Office Document Builder** using the following code:
...
// close the file and finish work with Maticon Office Document Builder
builder.CloseFile();
```

## Opening an existing form document

If you want to edit an already existing form document, you can open it using **Maticon Office Document Builder**, get its elements and change them however you need. The document is opened the following way:

```ts
// use a path or URL to an existing 'myformdocument.pdf' form document file to open it with Maticon Office Document Builder
...
// close the form document file and finish work with Maticon Office Document Builder
builder.CloseFile();
```
