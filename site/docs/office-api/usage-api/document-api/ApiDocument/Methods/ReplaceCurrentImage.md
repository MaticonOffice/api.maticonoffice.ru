...
let drawing = Api.CreateImage(
	'https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png',
	60 * 36000, 60 * 36000
);
paragraph.AddDrawing(drawing);
drawing.Select();
doc.ReplaceCurrentImage('https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png');
```
