...
To create a PDF document with **Maticon Office Document Builder**, you first create a document in an editable format (DOCX) and then save it as PDF. The simplest example creates a single page with centered "Center" text:

```ts
// create a document file with Maticon Office Document Builder
...
```ts
// use a path or URL to an existing 'mydocument.pdf' file to open it with Maticon Office Document Builder
