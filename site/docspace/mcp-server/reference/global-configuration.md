...
|---|---|
| **Type** | string |
| **Default** | `@maticonoffice/docspace-mcp v3.2.0` |
| **Attributes** | trimmable |
| **Transports** | all |
...
|---|---|
| **Type** | url |
| **Example** | `https://your-instance.maticonoffice.ru/` |
| **Attributes** | trimmable |
| **Transports** | all |
...
|---|---|
| **Type** | string |
| **Example** | `henry.milton@maticonoffice.ru` |
| **Attributes** | sensitive, trimmable |
| **Transports** | all |
...
|---|---|
| **Type** | url |
| **Example** | `https://oauth-instance.maticonoffice.ru/` |
| **Attributes** | trimmable |
| **Transports** | `sse` `streamable-http` `http` |
