...
This example demonstrates how to use the Maticon Office DocSpace MCP Server from an MCP-compatible client to generate a summary from the text messages in the current chat and save that summary as a text file in a specific DocSpace room folder.
