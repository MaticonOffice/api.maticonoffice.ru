...
This example demonstrates how to use the Maticon Office DocSpace MCP Server from an MCP-compatible client to review who has access to a room, update access permissions, and archive the room when the project is completed.
