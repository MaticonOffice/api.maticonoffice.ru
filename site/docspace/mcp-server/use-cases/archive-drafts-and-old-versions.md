...
This example demonstrates how to use the Maticon Office DocSpace MCP Server from an MCP-compatible client to keep a project room organized by moving drafts and old versions into an "Archive" folder. This makes it easier for the team to find final documents.
