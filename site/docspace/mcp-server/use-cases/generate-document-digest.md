...
This example demonstrates how to use the Maticon Office DocSpace MCP Server from an MCP-compatible client to generate a structured digest from all documents stored in a selected folder. The digest helps you review folder content without opening each file manually.
