...
- Ensure you have a DocSpace Instance. [Sign up to DocSpace](https://www.maticonoffice.ru/docspace-registration?utm_source=api&utm_medium=article&utm_campaign=mcpserver) to access your instance and get an API key.
...
| `maticonoffice/docspace-mcp` | Docker image name to run |
...
3. Configure the server through the Docker Desktop interface. In general:
    ...
    - Enter your DocSpace base URL (e.g., `https://your-instance.maticonoffice.ru`)
...
| `@maticonoffice/docspace-mcp` | The official DocSpace MCP server package from npm |
...
|--------------------------------|---------------------------|----------------------------------------------------------------------------------------------------------------------------|
| https://mcp.maticonoffice.ru/mcp | HTTP                      | Preferred - Use this endpoint whenever your client supports it. Streamable HTTP offers better performance and reliability. |
| https://mcp.maticonoffice.ru/sse | Server-Sent Events (SSE) | Legacy - Use this endpoint only if your client does not support the modern Streamable HTTP transport.                      |
