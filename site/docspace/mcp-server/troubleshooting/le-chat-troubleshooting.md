...
2. In the **Connectors** list, make sure **MATICONOFFICE_DocSpace_MCP** (or the name you assigned) is selected.
...
- Check that the server URL is `https://mcp.maticonoffice.ru/mcp` and that **OAuth2.1** is selected as the authentication method.
