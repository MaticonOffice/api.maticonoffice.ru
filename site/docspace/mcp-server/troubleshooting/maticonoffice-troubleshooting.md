---
sidebar_position: 3
sidebar_label: Maticon Office Desktop Editors
title: Resolving errors with the Maticon Office Desktop Editors
---

The following issues can occur when connecting the Maticon Office Desktop Editors to the DocSpace MCP server.
...
- Make sure Docker Desktop is running before starting Maticon Office Desktop Editors.
...
The configuration is not saved, or Maticon Office Desktop Editors shows a parse error after clicking **Save**. Fix this by:
...
1. Stop any existing containers:
  ```bash
  docker stop $(docker ps -q --filter ancestor=maticonoffice/docspace-mcp)
  ```
2. Restart the MCP server from Maticon Office Desktop Editors.
