...
``` json
{
  ...
  "data": {
    ...
    "location": "https://example.maticonoffice.ru/ChunkedUploader.ashx?uid=00000000000000000000000000000000",
    "path": [12345]
  }
}
```
...
const url = `https://example.maticonoffice.ru/api/2.0/files/${folderId}/upload/create_session`;
