...
<Tabs>
  <TabItem value="nodejs" label="Node.js">
    ...
    axios.get("https://yourportal.maticonoffice.ru/api/2.0/people/@self", { headers })
  ...
  <TabItem value="python" label="Python">
    ...
    response = requests.get("https://yourportal.maticonoffice.ru/api/2.0/people/@self", headers=headers)
  ...
  <TabItem value="csharp" label="C#">
    ...
    var response = await client.GetAsync("https://yourportal.maticonoffice.ru/api/2.0/people/@self");
  ...
  <TabItem value="curl" label="cURL">
    ``` sh
    curl -u yourusername:yourpassword https://yourportal.maticonoffice.ru/api/2.0/people/@self
    ```

    Or using the `Authorization` header:
    ``` sh
    curl -H "Authorization: Basic $(echo -n "yourusername:yourpassword" | base64)" https://yourportal.maticonoffice.ru/api/2.0/people/@self
    ```
  </TabItem>
</Tabs>
