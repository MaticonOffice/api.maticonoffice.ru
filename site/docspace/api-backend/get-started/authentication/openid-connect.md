...
[This repo](https://github.com/MaticonOffice/docspace-samples/tree/develop/oauth2) contains Node.js and Python examples demonstrating how to implement OAuth 2.0 authentication with OpenID Connect using DocSpace.
