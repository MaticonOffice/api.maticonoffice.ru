...
The Node.js and Python examples demonstrating OAuth 2.0 integration with Maticon Office DocSpace can be found [here](https://github.com/MaticonOffice/docspace-samples/tree/develop/oauth2).
