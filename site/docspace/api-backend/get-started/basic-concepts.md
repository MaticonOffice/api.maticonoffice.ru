...
title: Introducing Maticon Office DocSpace
---

[Maticon Office DocSpace](https://www.maticonoffice.ru/docspace.aspx) is a collaborative cloud platform that allows users to edit and collaborate on documents, spreadsheets, presentations, PDFs, and forms in customizable rooms. It provides the following features:
...
- creating, editing and viewing documents, spreadsheets, presentations, fillable forms, PDFs, ebooks, multimedia files using the built-in [Maticon Office Docs](../../../docs/docs-api/get-started/basic-concepts.md);
...
:::info
The Maticon Office DocSpace API is implemented as REST over HTTP using GET/POST/PUT/DELETE. All resources, like rooms, files, or users, have their own URLs and are designed to be manipulated in isolation.
:::

## Basic concepts

Before getting started with Maticon Office DocSpace, here are some terms to get familiar with:

- **Portal:** A secure, web-based [gateway](../usage-api/get-portal-information.api.mdx) that provides an interface for you to access, interact and use Maticon Office DocSpace. This portal enables you to create and manage rooms, users, files, API keys, AI agents, and other DocSpace resources.
...
Follow these steps to get started with Maticon Office DocSpace:

### Step 1: Get Maticon Office DocSpace

[Get Maticon Office DocSpace](get-maticonoffice-docspace.md) via the cloud or by installing it on your local server.

### Step 2: Authenticate your account

Authenticate your account using API keys, OAuth, or any of the other [authentication methods](authentication/authentication.md) available on Maticon Office DocSpace. This quickstart uses API keys. Follow these steps on [how to create and use API keys](./authentication/api-keys.md#how-to-create-api-keys) for your request.
...
- **API_KEY**: Maticon Office API key.
...
Maticon Office DocSpace has some restrictions on authenticated requests:
