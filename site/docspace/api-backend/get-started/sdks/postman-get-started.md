...
The Maticon Office DocSpace SDK for Postman is a simple Postman Collection for integrating with the Maticon Office DocSpace API.
...
**[Maticon Office Postman Collection on GitHub](https://github.com/MaticonOffice/docspace-api-postman-collections)**
...
- **Open in Postman** — open the collection directly in the Postman web app:
  [https://www.postman.com/maticonoffice/maticonoffice-docspace](https://www.postman.com/maticonoffice/maticonoffice-docspace)

- **Download the JSON file** — download `postman.json` from the [GitHub repository](https://github.com/MaticonOffice/docspace-api-postman-collections) and import it into Postman via **File → Import**.
...
|---|---|---|
| `baseUrl` | The URL of your DocSpace instance | `https://your-docspace.maticonoffice.ru` |
