...
This integration retrieves the name of a Trello board and creates a new room in Maticon Office DocSpace with the same title. It's helpful for mirroring Trello project structures into your document collaboration environment.
