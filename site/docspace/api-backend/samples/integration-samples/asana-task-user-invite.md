...
This integration automatically retrieves the email of the assignee from an Asana task and invites them to Maticon Office DocSpace. It helps ensure that project contributors are granted access to collaborative workspaces without manual steps.
...
MATICONOFFICE_API_KEY = "your_docspace_api_key"
...
def invite_user_to_docspace(email):
    url = f"https://{MATICONOFFICE_API_HOST}/api/2.0/people/invite"
    payload = {
        "invitations": [
