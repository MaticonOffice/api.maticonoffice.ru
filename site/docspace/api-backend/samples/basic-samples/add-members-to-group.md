...
This example demonstrates how to add one or more members to an existing group in Maticon Office DocSpace using the API. Optionally, you can rename the group and assign a new manager in the same request.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/add-members-to-group.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/add-members-to-group.py)
