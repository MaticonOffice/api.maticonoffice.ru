...
This example demonstrates how to update group manager in Maticon Office DocSpace.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/update-group-manager.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/update-group-manager.py)
