...
This example demonstrates how to programmatically create a new room in Maticon Office DocSpace and invite a user to it via email with specific access permissions.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/create-room-invite-user.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/create-room-invite-user.py)
