...
This example demonstrates how to create a daily backup schedule in Maticon Office DocSpace using the API (e.g., run every day at 03:00, keep the last 7 backups, optionally include a full portal dump).

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/create_backup_schedule.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/create_backup_schedule.py)
