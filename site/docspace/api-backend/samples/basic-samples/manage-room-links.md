...
This example demonstrates how to set and retrieve room invitation or external links in Maticon Office DocSpace using the API. These links provide access to rooms based on specified permissions.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/manage-room-links.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/manage-room-links.py)
