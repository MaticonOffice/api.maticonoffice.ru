...
This example automates the process of creating new users and sending them invitations in Maticon Office DocSpace. It ensures that only newly created users receive invitations, avoiding unnecessary duplicate invites.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/invite-users.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/invite-users.py)
