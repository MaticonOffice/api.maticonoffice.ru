...
This example demonstrates how to configure Developer Tools access settings in Maticon Office DocSpace. You can allow full access or limit it for regular users.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/set-developer-tools-access.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/set-developer-tools-access.py)
