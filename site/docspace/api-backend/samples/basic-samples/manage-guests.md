...
This example demonstrates how to manage a guest user in Maticon Office DocSpace using the API. The script includes two main operations:

- Approving a guest who was invited via sharing.
- Deleting the guest by their unique ID.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/manage-guests.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/manage-guests.py)
