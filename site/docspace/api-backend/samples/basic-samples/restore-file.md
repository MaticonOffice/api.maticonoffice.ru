...
This example demonstrates how to retrieve the edit history of a file in Maticon Office DocSpace and restore it to a specific previous version using the API.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/restore-file.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/restore-file.py)
