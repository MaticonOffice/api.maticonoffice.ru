...
This example demonstrates how to duplicate one or more files and folders in Maticon Office DocSpace using the API. The duplicated items will appear in the same location with a modified title.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/duplicate-files-and-folders.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/duplicate-files-and-folders.py)
