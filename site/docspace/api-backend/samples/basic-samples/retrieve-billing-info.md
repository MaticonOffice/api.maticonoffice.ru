...
This example demonstrates how to read billing-related information in Maticon Office DocSpace via the API: customer profile, balance by currency, current quota, available quotas, auto top-up settings, and supported currencies.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/retrieve_billing_and_payment_information.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/retrieve_billing_and_payment_information.py)
