...
This example demonstrates how to delete the current portal’s backup schedule in Maticon Office DocSpace using the API.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/delete-backup-schedule.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/delete-backup-schedule.py)
