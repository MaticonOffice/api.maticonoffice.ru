...
This example demonstrates how to retrieve the contents of a folder or room in Maticon Office DocSpace. The same API endpoint returns both files and subfolders.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/get-folder-room-content.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/get-folder-room-content.py)
...
<Tabs>
  ...
  ``` ts
  // Set API base URL
  const API_HOST = 'yourportal.maticonoffice.ru';
