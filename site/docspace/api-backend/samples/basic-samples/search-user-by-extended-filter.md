...
This example demonstrates how to retrieve a list of users in Maticon Office DocSpace with optional extended filter parameters such as group ID, employee type, administrator status, and result limit.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/search-user-by-extended-filter.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/search-user-by-extended-filter.py)
