...
This example demonstrates how to check the progress of a backup process in Maticon Office DocSpace using the API. The response includes information such as completion status, backup type, and download link if available.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/get-backup-progress.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/get-backup-progress.py)
