...
This example demonstrates how to delete a specific backup in Maticon Office DocSpace using the API by providing its unique backup ID.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/delete-backup.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/delete-backup.py)
