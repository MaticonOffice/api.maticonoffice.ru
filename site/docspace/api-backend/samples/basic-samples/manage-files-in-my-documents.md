...
This example demonstrates how to interact with a user's personal space ("My Documents") in Maticon Office DocSpace using the API. It includes retrieving contents, uploading a file, creating a new document, and deleting a file.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/manage-files-in-my-documents.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/manage-files-in-my-documents.py)
