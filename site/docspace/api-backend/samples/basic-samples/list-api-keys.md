...
This example demonstrates how to retrieve all API keys associated with the current user in Maticon Office DocSpace. The response includes metadata such as name, permissions, status, and expiration date.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/list-api-keys.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/list-api-keys.py)
