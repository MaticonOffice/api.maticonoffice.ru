...
This example demonstrates how to manage rooms in Maticon Office DocSpace using the API. It covers creating, retrieving, renaming, archiving, and deleting rooms through API requests.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/manage-rooms.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/manage-rooms.py)
...
<Tabs>
  ...
  # Set API base URL
  BASE_URL = 'https://yourportal.maticonoffice.ru'
