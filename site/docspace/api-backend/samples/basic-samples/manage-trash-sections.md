...
This example demonstrates how to retrieve, restore, and empty the contents of the Trash section in Maticon Office DocSpace using the API.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/manage-trash-sections.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/manage-trash-sections.py)
