...
This example demonstrates how to authenticate a user in Maticon Office DocSpace using the API and check the authentication with a token received.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/authentication.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/authentication.py)

## Before you start

Replace `https://yourportal.maticonoffice.ru` with your actual DocSpace portal URL, replace `USER_CREDENTIALS` with your credentials.
