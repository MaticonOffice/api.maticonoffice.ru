...
This example demonstrates how to create a new file inside a specific folder in Maticon Office DocSpace using the API. After creation, the file is automatically opened in the default web browser using the returned editor link.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/create-and-open-new-file.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/create-and-open-new-file.py)
