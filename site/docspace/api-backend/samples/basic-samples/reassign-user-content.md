...
This example demonstrates how to reassign a user’s data to another user in Maticon Office DocSpace via the API: check if reassignment is required, start the reassignment, monitor progress, and optionally terminate the task.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/reassign-user-content-to-another-user.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/reassign-user-content-to-another-user.py)
