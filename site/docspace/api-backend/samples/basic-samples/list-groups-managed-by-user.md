...
This example demonstrates how to retrieve the list of groups in Maticon Office DocSpace that are managed by a specific user.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/list-groups-managed-by-user.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/list-groups-managed-by-user.py)
