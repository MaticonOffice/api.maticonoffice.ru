...
This example demonstrates how to lock or unlock the specified file in Maticon Office DocSpace and get a list of users and their access levels for the file.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/lock-unlock-file.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/lock-unlock-file.py)
