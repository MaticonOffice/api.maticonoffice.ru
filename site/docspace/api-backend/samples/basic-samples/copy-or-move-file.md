...
This example demonstrates how to copy or move a file in Maticon Office DocSpace.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/copy-or-move-file.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/copy-or-move-file.py)
