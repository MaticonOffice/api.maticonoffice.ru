...
This example demonstrates how to remove one or more members from a group in Maticon Office DocSpace using the API.

Complete source code on GitHub: [Node.js](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/nodejs/samples/remove-members-from-group.js)/[Python](https://github.com/MaticonOffice/docspace-samples/blob/master/api-backend/python/samples/remove-members-from-group.py)
