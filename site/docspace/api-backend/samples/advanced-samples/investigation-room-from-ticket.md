...
This example shows how to create a dedicated investigation room in Maticon Office DocSpace when your helpdesk system (Zendesk / Freshdesk / Jira Service Management) reports a new ticket.
