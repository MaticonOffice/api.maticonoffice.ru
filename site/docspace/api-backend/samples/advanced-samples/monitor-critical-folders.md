...
This example shows how to monitor a critical folder (for example, **Compliance**) in Maticon Office DocSpace and notify the department owner whenever a file in that folder is changed.
