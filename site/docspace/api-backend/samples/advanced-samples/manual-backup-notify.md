...
This example shows how to trigger a manual portal backup in Maticon Office DocSpace and send a notification to an administrator with the backup status and details.
