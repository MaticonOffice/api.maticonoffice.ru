...
This example shows how to detect potentially suspicious user behavior in Maticon Office DocSpace by analyzing audit logs and automatically applying temporary restrictions.
