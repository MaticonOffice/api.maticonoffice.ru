...
- A running DocSpace instance, either [cloud](https://www.maticonoffice.ru/docspace-registration.aspx?from=api) or [self-hosted](https://www.maticonoffice.ru/download-developer.aspx?from=api#docspace-developer)
...
To see what the SDK looks like in a real product, explore the [live demo](https://demo-embed.maticonoffice.ru/) — a sample conference website with DocSpace embedded across multiple pages, each using a different mode:

| Page | What's embedded |
| --- | --- |
| [Home](https://demo-embed.maticonoffice.ru/) | Presentation playing in the Viewer mode |
| [Program](https://demo-embed.maticonoffice.ru/444-2/) | Spreadsheet in the Viewer mode; participant documents in an embedded file list |
| [Abstract Submission](https://demo-embed.maticonoffice.ru/abstract-submission/) | Fillable form open in the Editor mode |
| [Promotional Toolkit](https://demo-embed.maticonoffice.ru/promotional-toolkit/) | Marketing materials browsable in an embedded file list |
| [Registration](https://demo-embed.maticonoffice.ru/registration-2/) | Price list spreadsheet in the Viewer mode |
