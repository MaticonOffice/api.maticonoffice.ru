...
There are two ways to embed a working DocSpace instance in your web application. You can do it using an HTML script tag, or installing our [npm package](https://www.npmjs.com/package/@maticonoffice/docspace-sdk-js). Both methods render DocSpace inside a `div` you control.
...
```html
<script src="https://your-docspace.maticonoffice.ru/static/scripts/sdk/2.2.0/api.js"></script>
```
...
const docSpace = DocSpace.SDK.initManager({
  frameId: "ds-frame",
  src: "https://your-docspace.maticonoffice.ru",
});
```
...
cd docspace-app
npm install
npm install @maticonoffice/docspace-sdk-js
```
