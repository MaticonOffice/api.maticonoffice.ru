...
This example shows how to create a simple project tracker that interacts with DocSpace. Each project is represented as a folder inside a shared room. You can add or remove projects, and when a project is deleted, all associated files are locked using the Maticon Office API.

Complete source code on GitHub: [JavaScript](https://github.com/MaticonOffice/docspace-samples/blob/master/js-sdk/advanced-samples/project-manager-folder-integration.html)
