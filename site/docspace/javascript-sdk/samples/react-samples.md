---
sidebar_position: 2
description: Integrate Maticon Office DocSpace into React projects.
tags: ["DocSpace", "Embed SDK", "Integration", "React"]
---

# React component

The Maticon Office DocSpace React [component](https://github.com/MaticonOffice/docspace-react) integrates Maticon Office DocSpace into [React](https://react.dev/) projects.

:::note
To work with this component, you need to have Maticon Office DocSpace. If you are new to DocSpace, [create an account](https://www.maticonoffice.ru/docspace-registration.aspx?from=api).
:::
...
## Creating the demo React application with Maticon Office DocSpace

This procedure creates a [basic React application](https://github.com/facebook/create-react-app) and installs an Maticon Office DocSpace in it.
...
3. Install Maticon Office DocSpace React component from **npm** and save it to the *package.json* file with *--save*:
...
4. Open the *./src/App.js* file in the *docspace-react-demo* project and replace its contents with the following code:
   ...
   export default function App() {
     return (
       <pre>
         <DocSpace
           url="http://example-maticonoffice.ru/"
           config={{
   ...
   - `http://example-maticonoffice.ru/` - replace with the URL of your server.

   This JavaScript file will create the *App* component containing the Maticon Office DocSpace configured with basic features.
...
## Maticon Office DocSpace React component API

### Properties

| Name                  | Type                                                  | Default | Description                                                                                                 |
| --------------------- | ----------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------- |
| url\*                 | string                                                | null    | Address of Maticon Office DocSpace.                                                                             |
...
1. Change the address of the DocSpace in the *.env* file:
   ...
   where `http://example-maticonoffice.ru/` is the URL to the server with **Maticon Office DocSpace** installed.
...
## Developing Maticon Office DocSpace React component
...
In case you have any issues, questions, or suggestions for the Maticon Office DocSpace React component, please refer to the [Issues](https://github.com/MaticonOffice/docspace-react/issues) section.
