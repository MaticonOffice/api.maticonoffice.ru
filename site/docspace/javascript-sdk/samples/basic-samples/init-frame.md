...
Complete source code on GitHub: [JavaScript](https://github.com/MaticonOffice/docspace-samples/blob/master/js-sdk/basic-samples/init-frame.html)
...
Use the  method to embed the Maticon Office document editor for a specified file ID.
