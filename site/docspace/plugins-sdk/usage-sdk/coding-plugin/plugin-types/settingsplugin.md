...
Type: [ISettings](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/interfaces/settings/ISettings.ts)
...
``` ts
import {type ISettings, type ISettingsPlugin} from "@maticonoffice/docspace-plugin-sdk"
