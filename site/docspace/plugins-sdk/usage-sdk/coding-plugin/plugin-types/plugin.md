...
Type: [PluginStatus](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/enums/Plugins.ts)
...
| ------ | -------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------- |
| status | [PluginStatus](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/enums/Plugins.ts) | "active" | Defines a new plugin status (**active** or **hide**). |
...
``` ts
import {type IPlugin, PluginStatus} from "@maticonoffice/docspace-plugin-sdk"
