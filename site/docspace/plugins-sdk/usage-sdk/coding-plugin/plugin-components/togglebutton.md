...
See the parameters of this component in [storybook](https://storybook.maticonoffice.ru/?path=/docs/components-togglebutton--docs).
...
``` ts
import {Actions, type IMessage, type IToggleButton} from "@maticonoffice/docspace-plugin-sdk"
