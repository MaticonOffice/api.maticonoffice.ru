...
**Interface**: [Component](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/interfaces/components/Component.ts).
...
``` ts
import {Actions, type ButtonGroup, ButtonSize, Components, type IButton, type IMessage, ToastType} from "@maticonoffice/docspace-plugin-sdk"
