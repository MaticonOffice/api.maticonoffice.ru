...
**Interface**: [IImage](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/interfaces/components/IImage.ts).

## Example

``` ts
import {type IImage} from "@maticonoffice/docspace-plugin-sdk"
