...
| eventType    | [Events](https://github.com/MaticonOffice/docspace-plugin-sdk/blob/master/src/enums/Events.ts)                | `Events.CREATE`                                                   | Defines the event type which will be executed. Presently the following events are available: **CREATE, RENAME, ROOM\_CREATE, ROOM\_EDIT, CHANGE\_COLUMN, CHANGE\_USER\_TYPE, CREATE\_PLUGIN\_FILE**.                                                                                                     |
...
``` ts
import {Events, type IEventListenerItem} from "@maticonoffice/docspace-plugin-sdk"
