...
1. Install the *@maticonoffice/docspace-plugin-sdk* npm package globally:
...
You can create a plugin in any project by adding the *@maticonoffice/docspace-plugin-sdk* npm package as the dependency and specifying all the necessary fields in the *package.json* file.
...
``` json
{
  ...
  "license": "MIT",
  "logo": "logo.png",
  "homepage": "https://github.com/MaticonOffice/docspace-plugins/tree/master/pdf-converter",
  "cspDomains": [
