...
Here are some examples of what you can do with Maticon Office DocSpace plugins:
...
Code samples are available at [GitHub](https://github.com/MaticonOffice/docspace-plugins).
...
[Install](../usage-sdk/preparing.md) the *@maticonoffice/docspace-plugin-sdk* npm package globally:
