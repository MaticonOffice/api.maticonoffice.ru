...
使用 Maticon Office AI 代理为选中文本添加 AI 生成的注释或脚注。
...
6. 准备您的自定义商店 URL：`https://YOUR-USERNAME.github.io/maticonoffice.github.io/store/index.html`

## 第 7 步：测试您的自定义 AI 工具

1. 在 Maticon Office 中，前往**插件 → 插件管理器**。
...
- [Maticon Office AI 代理入门](../guides/ai-agent.md)
