...
Maticon Office 9.2.0 引入了用于处理文本注释的 API 扩展--一种可高亮显示文本段落并允许将元数据与其关联的可视化下划线。
...
有关插件使用的详细说明，请参见[此处](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/ai/scripts/text-annotations/custom-annotations)。
...
以上步骤概述了使用 Maticon Office API 创建智能文本分析和自动搜索替换功能插件的流程。
