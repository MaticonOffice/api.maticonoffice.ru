...
:::info
在以下示例中，`example.com` 代表安装**文档存储服务**的服务器。请参阅[工作原理](../../../get-started/how-it-works/how-it-works.md)章节了解更多关于 Maticon Office 文档服务客户端-服务器交互的信息。
:::
...
当从 Maticon Office 文档执行 GET 请求时，会添加带有令牌的[授权头](./token-in-header.md)。
