...
:::注意
在 [maticonoffice-docs-formats.json](https://github.com/MaticonOffice/document-formats/blob/master/maticonoffice-docs-formats.json) 文件中，您可以找到 Maticon Office 编辑器支持的所有文件格式及其属性（可能的操作、MIME 等）的列表。
:::
