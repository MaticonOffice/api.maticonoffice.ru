...
下图和步骤说明了如何在 Maticon Office 文档 中设置用户头像。
...
将 `example.com` 替换为提供头像图片的服务器地址，即您的**文档存储服务**或**文档编辑服务**可以访问的其他服务器。有关 Maticon Office 文档 客户端-服务器交互的更多信息，请参阅[工作原理](./how-it-works.md)。
