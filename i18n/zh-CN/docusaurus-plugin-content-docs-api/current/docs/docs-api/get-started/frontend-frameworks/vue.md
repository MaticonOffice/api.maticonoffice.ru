...
Maticon Office 文档 Vue.js[组件](https://github.com/MaticonOffice/document-editor-vue) 集成 Maticon Office 文档到 [Vue.js](https://vuejs.org/) 项目。

## 先决条件

此过程需要 [Node.js (和 npm)](https://nodejs.org/en)。

## 使用 Maticon Office 文档编辑器创建演示 Vue.js 应用程序

此过程创建一个[基本 Vue.js 应用程序](https://cli.vuejs.org/guide/creating-a-project.html#vue-create)基本 Vue.js 应用程序并在其中安装 Maticon Office 文档编辑器。

1. 打开命令行或命令提示符，并使用[创建 Vue 工具](https://github.com/vuejs/create-vue)，创建一个名为 *maticonoffice-vue-demo* 的 Vue.js 3.x 项目：
...
3. 从 **npm** 安装 Maticon Office 文档 Vue.js 组件，并使用 *--save* 将其保存到 *package.json* 文件中：
   
   ``` sh
   npm install --save @maticonoffice/document-editor-vue
   ```

4. 打开 *maticonoffice-vue-demo* 项目中的 *./src/App.vue* 文件，并将其内容替换为以下代码：
...
5. 使用 Vue 开发服务器测试应用程序：
   ...
   - 要启动开发服务器，请导航到 *maticonoffice-vue-demo* 目录并运行：
...
1. 导航到 *maticonoffice-vue-demo* 目录并运行：
...
2. 将 *maticonoffice-vue-demo/dist* 目录的内容复制到 Web 服务器的根目录（复制到 *maticonoffice-vue-demo* 文件夹）。

该应用程序将部署在 Web 服务器上（默认情况下 `http://localhost:3000`）。

## Maticon Office 文档 Vue 组件 API
...
如果您对 Maticon Office 文档 Vue有任何问题、疑问或建议，请参阅[问题](https://github.com/MaticonOffice/document-editor-vue/issues)部分。
