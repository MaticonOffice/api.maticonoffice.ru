...
Maticon Office 文档 Angular [组件](https://github.com/MaticonOffice/document-editor-angular-workspace) 将 Maticon Office 文档集成到 [Angular](https://angularjs.org/) 项目。

## 先决条件

此过程需要 [Node.js (和 npm)](https://nodejs.org/en).

## 使用 Maticon Office 文档编辑器创建演示 Angular 应用程序

此过程创建一个 [基本 Angular 应用程序](https://angular.io/guide/setup-local)，并在其中安装 Maticon Office 文档编辑器。
...
2. 创建一个名为 *maticonoffice-angular-demo* 的新 Angular 项目：
...
4. 从 **npm** 安装 Maticon Office Docs Angular 组件，并使用 *--save* 将其保存到 *package.json* 文件中：
...
1. 打开 *maticonoffice-angular-demo* 项目中的 *./src/app/app.module.ts* 文件并导入 **DocumentEditorModule**：
...
2. 打开 *maticonoffice-angular-demo* 项目中的 *./src/app/app.component.ts* 文件，并在您的使用组件中定义选项：
   ...
   - `https://example.com/url-to-example-document.docx` - 替换为您的文件的 URL；You can use the URL `https://static.maticonoffice.ru/assets/docs/samples/demo.docx` of our sample document for testing.
   - `https://example.com/url-to-callback` - 替换为您的回调 URL（这是保存功能正常工作所必需的）。

   此 TypeScript 文件将创建 *AppComponent* 组件，其中包含配置了基本功能的 Maticon Office 文档编辑器。
...
3. 在模板中，将*文档编辑器*组件与您的选项一起使用：
   ...
   将 `http://documentserver/` 行替换为您的服务器的 URL。You can [register](https://www.maticonoffice.ru/docs-registration.aspx?from=api) a free Maticon Office Cloud and use its public IP address or public DNS that can be found in the **Instances** section of the cloud console.

### 17.0.0 及更高版本

1. 打开 *maticonoffice-angular-demo* 项目中的 *./src/app/app.component.ts* 文件，并在您的使用组件中定义选项：
   ...
   - `https://example.com/url-to-example-document.docx` - 替换为您的文件的 URL；您可以使用我们的示例文档的 URL `https://static.maticonoffice.ru/assets/docs/samples/demo.docx` 进行测试。
   - `https://example.com/url-to-callback` - 替换为您的回调 URL（这是保存功能正常工作所必需的）。
...
2. 在模板中，将 *document-editor* 组件与您的选项一起使用：
   ...
   将 `http://documentserver/` 行替换为您的服务器的 URL。您可以[注册](https://www.maticonoffice.ru/zh/docs-registration.aspx?from=api)一个免费的 Maticon Office 云，并使用其公共 IP 地址或公共 DNS，这些地址或 DNS 可以在云控制台的**实例**部分找到。

使用 Node.js 开发服务器测试应用程序：

- 要启动开发服务器，请导航到 *maticonoffice-angular-demo* 目录并运行：
...
1. 导航到 *maticonoffice-angular-demo* 目录并运行：
...
2. 将 *dist/maticonoffice-angular-demo* 目录的内容复制到 Web 服务器的根目录（复制到 *maticonoffice-angular-demo* 文件夹）。

该应用程序将部署在 Web 服务器上（默认情况下 `http://localhost:3000`）。

## Maticon Office 文档 Angular 组件API
...
| documentServerUrl\*                  | string                  | null    | Maticon Office 文档服务器的地址。                                                                                                                                |
...
## 开发 Maticon Office 文档 Angular 组件
...
如果您对 Maticon Office 文档 Angular 组件有任何问题、疑问或建议，请参阅[问题](https://github.com/MaticonOffice/document-editor-angular-workspace/issues)部分。
