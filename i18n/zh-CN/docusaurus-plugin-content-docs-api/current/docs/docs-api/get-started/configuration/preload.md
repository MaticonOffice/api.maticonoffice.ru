...
其中，`documentserver` 是安装了 Maticon Office 文档的服务器名称。

:::tip
还没有文档服务器？[注册](https://www.maticonoffice.ru/zh/docs-registration?from=api)一个免费的 Maticon Office 文档云，并使用实例的公共 IP 地址或公共 DNS 名称作为 `documentserver`。您可以在云控制台的**实例**部分找到它们。
:::
