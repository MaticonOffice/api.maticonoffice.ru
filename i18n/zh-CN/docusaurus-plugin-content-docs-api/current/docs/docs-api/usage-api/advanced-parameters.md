...
- [`editorConfig`](./config/editor/editor.md) - 定义编辑器界面参数：打开模式、语言、回调 URL 等；
  ...
  - [`plugins`](./config/editor/plugins.md) - 将 [plugins](../../plugins/get-started/get-started.md) 连接到 Maticon Office 文档，供所有编辑器用户使用；
...
将 `example.com` 替换为您的**文档存储服务**的主机地址。请参阅[工作原理](../get-started/how-it-works/how-it-works.md)部分，了解有关 Maticon Office 文档 服务客户端-服务器交互的更多信息。
