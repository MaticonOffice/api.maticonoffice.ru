...
:::info
此方法仅适用于 [Maticon Office 文档开发者版](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api)。
:::
...
设置包含书签的文档的链接。此方法必须在 [onMakeActionLink](./config/events.md#onmakeactionlink) 事件之后调用。软件集成商必须处理从**文档编辑服务**接收到的 `ACTION_DATA` 以设置链接。 该链接由软件集成商创建，他们在 **文档管理器**中使用 Maticon Office 文档。
...
| 参数                     | 类型    | 是否必填 | 描述                                                                                                                                                                                                                                                                                                                 |
| ------------------------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| options.changesUrl        | `string` | 非必填的 | 带有文档更改数据的文件的url地址，可以通过 `changesurl` 链接从保存文档后返回的 [JSON对象](./callback-handler.md#changesurl) 中下载。文件请求使用由 Maticon Office 文档检查的令牌进行签名。            |
| options.error             | `string` | 非必填的 | 错误消息文本。                                                                                                                                                                                                                                                                                             |
...
:::info
此方法仅适用于 [Maticon Office 文档企业版](https://www.maticonoffice.ru/docs-enterprise-prices.aspx?from=api)和 [Maticon Office 文档开发者版](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api)。
:::
