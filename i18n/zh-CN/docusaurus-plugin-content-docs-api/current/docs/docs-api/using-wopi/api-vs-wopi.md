...
您可以使用 API 或 WOPI 将 [Maticon Office 文档](https://www.maticonoffice.ru/office-suite.aspx)与任何云服务集成。
...
| **集成**           | [即用型连接器](https://www.maticonoffice.ru/all-connectors.aspx)                                    | WOPI 连接器                                                                                             |
| **协作（模式）**       | 实时和段落锁定                                                                                     | 仅实时                                                                                                  |
| **定制**           |                                                                                             |                                                                                                      |
