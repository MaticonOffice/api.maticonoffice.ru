...
## 在哪里可以找到 Maticon Office 文档的集成示例？ {#where-can-i-find-integration-examples-for-maticonoffice-docs}

可以在[此处](../../samples/language-specific-examples/language-specific-examples.md)找到将 Maticon Office 文档与您自己的网站集成的示例。您可以在不同的 Web 开发编程语言中进行选择：
...
这些示例将显示从何处获取源代码，如何安装和设置工作示例，以便将 Maticon Office 文档集成到您的网站中，它们是用其中一个编程语言编写的。

如果您想将 Maticon Office 文档连接到现有的文档管理服务之一，您可以查看以下服务的现成连接器：
...
大多数连接器可从相应的服务应用程序商店获得，并且易于安装。只需按照[连接器页面](../../get-started/ready-to-use-connectors/nextcloud-integration.md)上的分步说明将 Maticon Office 文档连接到您的服务。

## 在将 Maticon Office 文档与我的网站集成时，我应该指定哪些路径？ {#which-paths-should-i-specify-when-integrating-maticonoffice-docs-with-my-website}

下载并解压用于将 Maticon Office 文档与您的网站集成的示例后，您需要打开源代码并将 **https\://documentserver/** 字符串的所有实例替换为您安装的 Maticon Office 文档的实际地址。

## 通过本地和公共网络将 Maticon Office 连接到 ownClowd/Nextcloud 时应该使用哪些设置？ {#what-settings-should-be-used-when-connecting-maticonoffice-to-ownclowdnextcloud-via-a-local-and-public-network}

将 ownCloud/Nextcloud安装连接到 Maticon Office 文档时，您需要确保 Internet 浏览器和 ownCloud/Nextcloud 安装都可以访问安装了 Maticon Office 文档的服务器，即一台可以向它发送请求，也可以接受来自它的响应的安装了 Maticon Office 文档的计算机。

ownCloud 安装和 Maticon Office 文档之间的交互方案可在[此处](../../get-started/ready-to-use-connectors/owncloud-integration.md#configuring-owncloud-maticonoffice-integration-app)获得。如果您使用 Nextcloud，请访问[此页面](../../get-started/ready-to-use-connectors/nextcloud-integration.md#configuring-nextcloud-maticonoffice-integration-app)以了解如何正确设置服务器。
