...
宏是一种小型脚本，可帮助您在处理不同类型文档的日常工作中提高效率。Maticon Office 宏使用 JavaScript 语法和 [Office JavaScript API](../../office-api/get-started/overview.md) 脚本规范。

Maticon Office 选择 JavaScript 作为宏的脚本语言的原因有以下几点：
