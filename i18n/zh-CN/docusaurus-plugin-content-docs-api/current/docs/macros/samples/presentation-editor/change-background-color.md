...
(function()
{
    ...
    // 从图片创建图片填充
    let imageUrl = "https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png";
...
Sub SetSlideBackground()
    ...
    ' 设置图片的 URL
    imageUrl = "https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png"
