...
const url1 = 'https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png';
const url2 = 'https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png';
