...
const image = Api.CreateImage('https://static.maticonoffice.ru/assets/docs/samples/img/presentation_sky.png', 174 * 36000, 38 * 36000);
...
const oleObject = Api.CreateOleObject(
	'https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png',
	150 * 36000, 150 * 36000,
