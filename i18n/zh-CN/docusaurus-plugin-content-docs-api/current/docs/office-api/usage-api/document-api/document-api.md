...
使用 **Maticon Office Document Builder** 可以通过以下代码构建一个包含居中"Center"文本的单段落的最简单示例文本文档：
...
如果您想编辑已存在的文本文档，可以使用 **Maticon Office Document Builder** 打开它，获取其元素并根据需要进行更改。文档按以下方式打开：
