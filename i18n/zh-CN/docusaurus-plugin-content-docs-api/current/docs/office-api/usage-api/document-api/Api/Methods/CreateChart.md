...
:::note
*styleIndex* 超出 **1 - 48** 范围的值将被解释为来自 *cs:chartStyle* 元素的图表样式 ID（例如 201、215、284），且仅适用于 [Maticon Office Docs Enterprise](https://www.maticonoffice.ru/docs-enterprise-prices.aspx?from=api) 和 [Maticon Office Docs Developer](https://www.maticonoffice.ru/developer-edition-prices.aspx?from=api)。
:::
