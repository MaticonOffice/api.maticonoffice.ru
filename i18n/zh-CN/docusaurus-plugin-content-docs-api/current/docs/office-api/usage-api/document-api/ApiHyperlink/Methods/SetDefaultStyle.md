...
let hyperlink = paragraph.AddHyperlink("http://api.maticonoffice.ru/docbuilder/basic");
let copyHyperlink = copyParagraph.AddHyperlink("http://api.maticonoffice.ru/docbuilder/basic");
