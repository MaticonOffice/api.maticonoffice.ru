...
const logoUrl = 'https://static.maticonoffice.ru/assets/docs/samples/img/maticonoffice_logo.png';
worksheet.SetHyperlink('A1', logoUrl, null, 'Maticon Office for developers', 'Api Maticon Office');
```
