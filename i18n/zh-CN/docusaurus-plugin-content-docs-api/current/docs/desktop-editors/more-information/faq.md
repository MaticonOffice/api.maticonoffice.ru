...
## 如何安装 Maticon Office 桌面编辑器？

Maticon Office 桌面编辑器支持 Windows、Linux 和 macOS 系统。从 6.1 版本开始，该应用也支持基于 ARM 的 Apple Silicon 芯片的 Mac 设备。

在本地计算机上安装此应用最简单的方法是从我们的官方[网站](https://www.maticonoffice.ru/zh/download-desktop.aspx)下载。

对于某些 Linux 发行版，如 Zorin OS、Linux Mint、Linkat、Linspire 等，Maticon Office 桌面编辑器软件包已预装或可在其官方商店中获取。
...
通过这种方式，您只能将 DMS 提供商添加到自己的连接列表中。如果您想为所有用户添加，请在 [GitHub](https://github.com/MaticonOffice/DesktopEditors/issues) 上提交功能请求。
...
- 从 *sdkjs-plugins* 目录中删除 *cloud_crypto.xml* 文件。文件夹的路径取决于您使用的操作系统：
  ...
  - 对于 Linux - *home/\<username>/.local/share/maticonoffice/desktopeditors/sdkjs-plugins/*
  - 对于 Windows - *C:\Users\\\<username>\AppData\Local\Maticon Office\DesktopEditors\data\sdkjs-plugins\\*
