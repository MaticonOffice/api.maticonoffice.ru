...
1. 已安装 Maticon Office Document Builder。有关更多信息，请访问[安装页面](/docs/document-builder/get-started/installing.md)。
...
从 [https://github.com/MaticonOffice/document-builder-samples](https://github.com/MaticonOffice/document-builder-samples) 克隆包含 Document Builder 示例的仓库。创建的文件夹必须具有一般编辑权限。
...
如果您想将 `Maticon Office Document Builder SDK` 升级到最新版本，只需运行：
