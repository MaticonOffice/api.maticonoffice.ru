...
您可以使用 **Maticon Office Document Builder** 通过命令行（CLI）从 **.js** 脚本文件生成文档。要启动它，请运行：
...
:::info 服务器集成
有关在服务器上使用不同编程语言（C#、Node.js、PHP、Ruby）的 Document Builder CLI 示例，请参阅 [document-builder-integration](https://github.com/MaticonOffice/document-builder-integration) 仓库。
:::
