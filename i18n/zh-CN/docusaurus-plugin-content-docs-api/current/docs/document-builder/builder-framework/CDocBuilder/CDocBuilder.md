...
Maticon Office Document Builder 用于生成文档文件（文本文档、电子表格、演示文稿、表单文档、PDF）的基类。
...
| [Dispose](Dispose.md)                                      | 当不再需要时，从应用程序内存中卸载 Maticon Office Document Builder。*（不用于 .Net）*          |
| [Destroy](Destroy.md)                                      | 当不再需要时，从应用程序内存中卸载 Maticon Office Document Builder。*（仅限 .Net）*                 |
...
| [GetVersion](GetVersion.md)                                | 返回 Maticon Office Document Builder 引擎版本。*（不用于 COM）*                                                     |
| [Initialize](Initialize.md)                                | 将 Maticon Office Document Builder 初始化为库，以便应用程序能够使用它。                       |
...
| [Run](Run.md)                                              | 运行 Maticon Office Document Builder 可执行文件。                                                                                |
