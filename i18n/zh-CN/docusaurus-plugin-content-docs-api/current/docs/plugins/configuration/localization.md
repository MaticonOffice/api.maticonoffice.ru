...
[highlighting 插件代码](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/highlightcode)的完整 [config.json](configuration.md) 翻译如下：
...
错误输出：静默回退为英文 / Maticon Office 将默认语言设为英语，且不报错。
