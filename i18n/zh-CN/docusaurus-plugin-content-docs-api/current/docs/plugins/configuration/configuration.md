...
指定该插件是否包含在标有 Maticon Office 品牌的服务器版或桌面版中。
...
描述，即最能描述你插件的内容。将显示在 **Maticon Office 插件市场**。
...
插件在 **Maticon Office 插件市场**中描述用的截图图片文件。
...
插件在 **Maticon Office 插件市场**中的展示选项。
...
**Maticon Office 插件市场**中插件图标使用的背景颜色。
...
**Maticon Office 插件市场**中使用的插件图标图片文件路径。
...
用于 **Maticon Office 插件市场**插件描述的图片。
