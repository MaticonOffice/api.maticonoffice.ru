...
插件发布到 Maticon Office 插件市场后，您需要发布更新来修复错误、添加功能或保持与新版本 Maticon Office 的兼容性。

## 版本号规则 {#versioning-scheme}

Maticon Office 插件使用语义化版本号（`MAJOR.MINOR.PATCH`）：
...
## 指定最低 Maticon Office 版本 {#specifying-minimum-maticonoffice-version}
...
在 PR 描述中说明：变更内容、新的 Maticon Office 版本要求、错误修复或破坏性变更。
...
## 处理 Maticon Office 版本兼容性 {#handling-maticonoffice-version-compatibility}

每次 Maticon Office 发布新版本后进行测试：
- 所有 `executeMethod` 调用返回预期结果
- 事件处理程序正确触发
- UI 元素正确渲染

每次 Maticon Office 发布新版本后，请查阅[更新日志](../../more-information/changelog.md)。
...
在 [https://github.com/MaticonOffice/maticonoffice.github.io/issues](https://github.com/MaticonOffice/maticonoffice.github.io/issues) 提交 issue，注明插件名称和原因。
...
- [市场仓库](https://github.com/MaticonOffice/maticonoffice.github.io)
- [插件示例](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content)
