...
将 AI 提供商（如 OpenAI、DeepSeek）接入 Maticon Office 编辑器，实现智能文本生成、编辑、摘要提取及宏自动创建功能。
...
在 Maticon Office 企业版、社区版（文档 + 工作区）及 Maticon Office 云端中默认提供。

您也可以从 [Maticon Office 应用目录](https://www.maticonoffice.ru/app-directory/zh/ai)下载该插件，并按照[桌面版](../development-workflow/installing-and-testing/desktop-editors-installation.md)安装说明进行安装。

从 9.0.4 版本开始，AI 插件已加入具有 Maticon Office 品牌标识的服务器版和桌面版发行包。
...
3. 在 Maticon Office 编辑器顶部工具栏中找到新增的 **AI** 选项卡。
4. 选择以下功能之一：
...
有关如何添加自定义提供商的详细信息，请参阅此[博客文章](https://www.maticonoffice.ru/blog/zh-hans/2025/03/how-to-add-a-custom-provider-to-the-maticonoffice-ai-plugin)。

## 插件结构

GitHub 仓库：[ai](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/ai)。
...
如需请求功能或报告此插件的问题，请通过 [GitHub](https://github.com/MaticonOffice/maticonoffice.github.io/issues) 页面提交。
