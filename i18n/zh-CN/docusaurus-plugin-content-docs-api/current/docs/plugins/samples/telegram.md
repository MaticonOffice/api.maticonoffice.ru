...
将 Telegram 即时通讯应用集成到 Maticon Office 编辑器中。
...
**类似插件：** [Rainbow](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/rainbow)、[Jitsi](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/jitsi)
...
GitHub 仓库地址：[telegram](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/telegram)
...
3. 第三方服务：
   ...
   - [Telegram-react 应用](https://github.com/evgeny-nadymov/telegram-react)：该应用基于 ReactJS JavaScript 框架构建，使用了编译为 WebAssembly 的 TDLib（Telegram 数据库库）。许可证：[GNU 通用公共许可证](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/telegram/licenses/telegram-react.license)
