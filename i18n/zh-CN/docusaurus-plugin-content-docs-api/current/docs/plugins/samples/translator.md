...
**同类插件：** [Apertium](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/apertium)、[DeepL](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/deepl)
...
该插件在 Maticon Office 编辑器的云端、本地部署和桌面版本中默认提供。
...
GitHub 仓库：[translator](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/translator)
...
5. 第三方服务：
   ...
   - [jQuery](https://jquery.com) - 快速简洁的 JavaScript 库，可简化 HTML 文档遍历、事件处理、动画和 Ajax 交互。许可证：[MIT License](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/translator/licenses/jQuery.license)
   - [Select2](https://select2.org/) - 提供可搜索、支持远程数据集、无限滚动等功能的可自定义选择框。许可证：[MIT](https://github.com/MaticonOffice/maticonoffice.github.io/blob/master/sdkjs-plugins/content/translator/licenses/Select2.license)
