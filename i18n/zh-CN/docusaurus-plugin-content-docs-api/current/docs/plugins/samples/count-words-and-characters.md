...
该插件在 Maticon Office 企业版和社区版（文档或协作空间）中默认提供。

你也可以从 [Maticon Office 插件目录](https://www.maticonoffice.ru/app-directory/zh/wordscounter)下载此插件，并按照以下说明完成安装：[桌面端](../development-workflow/installing-and-testing/desktop-editors-installation.md)、[云端](../development-workflow/installing-and-testing/cloud-saas-installation.md)。
...
GitHub 上的仓库：[字数统计](https://github.com/MaticonOffice/maticonoffice.github.io/tree/master/sdkjs-plugins/content/wordscounter)。
