...
GitHub 仓库地址：[符号表](https://github.com/MaticonOffice/sdkjs-plugins/tree/master/symboltable)。
...
5. 第三方服务：
   ...
   - [jQuery](https://jquery.com)：简洁快速的 JavaScript 库，用于简化 HTML 文档遍历、事件处理、动画和 Ajax 交互。许可证：[MIT License](https://github.com/MaticonOffice/sdkjs-plugins/blob/master/symboltable/licenses/jQuery.license)。
   - [Select2](https://select2.org/)：提供可搜索、可标签化、支持远程数据和无限滚动的自定义选择框。许可证：[MIT](https://github.com/MaticonOffice/sdkjs-plugins/blob/master/symboltable/licenses/Select2.license)。
