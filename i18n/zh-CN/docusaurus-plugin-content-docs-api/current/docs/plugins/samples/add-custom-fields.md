...
从 [GitHub](https://github.com/MaticonOffice/sdkjs-plugins/tree/master/example_customfields_add) 下载此插件，并根据以下方式的说明进行安装：[**桌面端**](../development-workflow/installing-and-testing/desktop-editors-installation.md)、[**本地部署**](../development-workflow/installing-and-testing/docs-on-premises-installation.md) 或 [**云端**](../development-workflow/installing-and-testing/cloud-saas-installation.md)。
...
GitHub 仓库：[**example_customfields_add**](https://github.com/MaticonOffice/sdkjs-plugins/tree/master/example_customfields_add)
...
如果您想请求功能或报告关于此插件的错误，请使用 [GitHub](https://github.com/MaticonOffice/sdkjs-plugins/issues) 上的问题区。
