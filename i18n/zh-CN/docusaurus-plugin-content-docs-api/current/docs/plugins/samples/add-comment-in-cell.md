...
GitHub 仓库地址：[example_add_comment_in_cell](https://github.com/MaticonOffice/sdkjs-plugins/tree/master/example_add_comment_in_cell)。
...
如果你希望请求新功能或报告此插件的相关问题，请前往 [GitHub](https://github.com/MaticonOffice/sdkjs-plugins/issues) 的 issues 区提交。
