...
export const Samples: Samples = {
  items: [
    // ── Favorite ──
    {
      ...
      viewLink:'https://github.com/MaticonOffice/document-builder-samples/blob/master/cpp/creating_advanced_form/main.cpp',
      tags: [
...
export const BlogArticles: BlogArticles = {
  items: [
    {
      title: 'How to write an Maticon Office plugin with AI: the OData Import plugin case',
      link: "https://www.maticonoffice.ru/blog/2026/03/how-to-write-an-maticonoffice-plugin-with-ai-odata-import",
      imgHref: "/img/homepage-blog/odata-import-plugin-768x393.png",
    },
    {
      title: 'Manipulate PDF content with new MATICONOFFICE PDF Editor API',
      link: "https://www.maticonoffice.ru/blog/2026/03/manipulate-pdf-content-with-new-maticonoffice-pdf-editor-api",
      imgHref: "/img/homepage-blog/manipulate-pdf-768x390.png",
    },
    {
      title: 'How to handle async API calls inside MATICONOFFICE custom functions',
      link: "https://www.maticonoffice.ru/blog/2025/07/how-to-handle-async-api-calls-inside-maticonoffice-custom-functions",
