  ...
  items: [
    {
      ...
      description: (
        <>
          Integrate and configure Maticon Office Docs into your web app to enable document editing, co-authoring, and sharing for your users.
        </>
      ),
      icon: <DocsApiIcon/>,
    },
    ...
    },
    {
      ...
      description: (
        <>
          Extend and customize Maticon Office Desktop Editors by integrating with document management systems.
        </>
      ),
  ...
  items: [
    {
      ...
      description: (
        <>
          Integrate Maticon Office DocSpace into your application to interact with its REST API using GET, POST, PUT, and DELETE methods.
        </>
      ),
    ...
    },
	{
      ...
      description: (
        <>
          Connect AI tools directly to Maticon Office DocSpace to execute actions{" "}
  ...
  items: [
    {
      ...
      description: (
        <>
          In this section, you will learn how to integrate Maticon Office Workspace{" "}
          ...
          need to install Maticon Office Docs separately.
        </>
      ),
      icon: <DocSpaceApiIcon/>
    },
