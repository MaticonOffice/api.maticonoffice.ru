...
export default function SamplesPage(): ReactNode {
  ...
  return (
    <Layout
      ...
      description="Explore ready-to-use code examples for integrating MATICONOFFICE document editing into your applications across multiple languages and platforms."
    >
      <div className={layoutStyles.container}>
        <div className={layoutStyles.containerInner}>
          <div className={layoutStyles.headerSection}>
            <Heading as="h1" className="hero__title">Maticon Office API samples</Heading>
            <p>
              Explore a collection of ready-to-use code examples demonstrating
              how to integrate and extend MATICONOFFICE document editing and
          ...
          <div className={layoutStyles.helpSection}>
            ...
            <ul>
              <li>
                ...
                <a href="https://github.com/MaticonOffice/document-builder-samples">GitHub</a>.
              </li>
              <li>
                You can request a feature or report a bug by posting an issue on{' '}
                <a href="https://github.com/MaticonOffice/documentServer/issues">GitHub</a>.
              </li>
              <li>
                You can also ask our developers on{' '}
                <a href="https://forum.maticonoffice.ru/c/document-api/39">MATICONOFFICE forum</a> (registration required).
              </li>
            </ul>
          </div>
        </div>
