...
export const FILE_CONFIGS: Record<string, FileConfig> = {
    word: { ext: 'docx', docType: 'word', url: 'https://static.maticonoffice.ru/assets/docs/samples/new.docx' },
    pdf: { ext: 'pdf', docType: 'pdf', url: 'https://static.maticonoffice.ru/assets/docs/samples/blank.pdf' },
    cell: { ext: 'xlsx', docType: 'cell', url: 'https://static.maticonoffice.ru/assets/docs/samples/new.xlsx' },
    slide: { ext: 'pptx', docType: 'slide', url: 'https://static.maticonoffice.ru/assets/docs/samples/new.pptx' },
    form: { ext: 'pdf', docType: 'pdf', url: 'https://static.maticonoffice.ru/assets/docs/samples/new.pdf' },
};

export const SAMPLE_FILE_CONFIGS: Record<string, FileConfig> = {
    word: { ext: 'docx', docType: 'word', url: 'https://static.maticonoffice.ru/assets/docs/samples/demo.docx' },
    pdf: { ext: 'pdf', docType: 'pdf', url: 'https://static.maticonoffice.ru/assets/docs/samples/demo.pdf' },
    cell: { ext: 'xlsx', docType: 'cell', url: 'https://static.maticonoffice.ru/assets/docs/samples/demo.xlsx' },
    slide: {
        ext: 'pptx',
        docType: 'slide',
        url: 'https://static.maticonoffice.ru/assets/docs/samples/demo.pptx',
    },
    form: {
        ext: 'pdf',
        docType: 'pdf',
        url: 'https://static.maticonoffice.ru/assets/docs/samples/demo-invoice.pdf',
    },
};
...
const FORM_SCRIPTS: Template = {
    ...
    connector:
        ...
        '});\n' +
        '\n' +
        'connector.executeMethod("InputText", ["MATICONOFFICE Playground", ""]);\n',
